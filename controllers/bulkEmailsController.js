...
<body>
    <div class="container">
        <div class="header">
            <h1>Optivue Monthly Newsletter</h1>
            <p>{{month}} {{year}} Edition</p>
        </div>
        <div class="content">
            <h2>Hello {{name}}!</h2>
            <p>Here's what's new at Optivue this month:</p>

            <div class="highlight">
                <h3>🚀 New Features</h3>
                <ul>
                    <li>Enhanced AI-powered SEO recommendations</li>
                    <li>Improved Facebook Ads performance tracking</li>
                    <li>New analytics dashboard widgets</li>
                </ul>
            </div>

            <h3>Latest SEO Tips</h3>
            <p>{{seo_tip}}</p>
...
<head>
    ...
    <style>
        ...
        .button { display: inline-block; background-color: #dc2626; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; margin: 10px 0; font-weight: bold; }
    </style>
</head>
<body>
    <div class="container">
